                        ...
                        <div>
                            <div class="d-flex profile-wrapper">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="{{route('setting')}}" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                                </div>
                            </div>
                            <!-- Tab panes -->
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex flex-wrap gap-2 fs-15">
                                                        ...
                                                        <a href="javascript:void(0);" class="badge badge-soft-primary">{{$skills->name}}</a>
                                                        @endforeach
                                                    </div>
                                                </div><!-- end card body -->
                                            </div><!-- end card -->
