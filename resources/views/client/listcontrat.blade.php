                                ...
                                <div class="table-responsive table-card">
                                    <table class="table align-middle table-nowrap" id="invoiceTable">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sort text-uppercase" data-sort="email">Phone</th>
                                        ...
                                        <tr >
                                            ...
                                            <td  class="email">
                                                {{$contract->phone_freelancer}}
                                            </td>
                                            <td class="country">
                                                {{$contract->country_freelancer}}
                                            </td>
                                            <td  class="date">
                                                {{$contract->created_at}}
                                            </td>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <button class="dropdown-item"  onclick="ViewInvoice(this);" data-id="25000351">
                                                                <a href="{{route('contratdetailclient',['id'=>$contract->id])}}"><i class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                View</a>
                                                            </button>
                                                        </li>
                                                        <li>
