            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-xl-auto ">
                        <h1 class=animate__fadeIn">Client List</h1><hr>
                                        ...
                                        @foreach($client as $selectt => $c)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{route('client_destroy')}}" method="POST">
                                                        @csrf
                                                        <button type="submit" class="btn btn-outline-secondary btn-md" name="delete" value="{{$c->id}}">delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                        @endforeach
